...
class Email
{
    ...
    <body>
        ...
        <p>Por favor confirma tu correo electrónico para que puedas comenzar a utilizar las herramientas de AppCalculadora</p>
        <a href='http://localhost:3000/confirmar-cuenta?token=" . $this->token . "'><button>Verificar</button></a>
        <p>Si tú no te registraste en AppCalculadora, por favor ignora este correo electrónico.</p>
        <div><p></p></div>
